...
#### Sample Outputs
Below are sample outputs of the model trained for 30 epochs. The final achieved Dice coefficient was 0.92, and the loss was 0.02. Similar results can be achieved in far fewer epochs.
